...
$('#brandy').click(function(){
    $('.modal-content').empty().append('<div class="modal-header">'+
        ...
        '<div class="col-md-12">'+
        '<div class="flex">' +
        '<div><img src="assets/pair.png" alt="pair" />'+
...
$('#keops').click(function(){
    $('.modal-content').empty().append('<div class="modal-header">'+
        '<h2>Keops - Rédacteur en chef</h2>'+
        '</div>'+
        '<div class="modal-body">'+
        '<div class="row">'+
        '<div>'+
        '<img src="/assets/presentation/Keops.png" alt="Keops" class="img-presentation">'+
        '<p>Enchanté, je suis Keops mais vous me connaissez déjà puisque je suis le rédacteur' +
        'en chef du webzine depuis ses débuts, et je suis également aspirant scénariste.' +
        'Fasciné depuis l’enfance par le monde de la BD en général, cette passion ne veut toujours' +
        'pas me quitter. Alors j’espère que vous suivrez le Kippon Dream encore longtemps et que vous' +
        'nous permettrez de réaliser encore plus d’objectifs, jusqu’à la consécration' +
        '</p>' +
        '</div>'+
        '</div>'+
        '<div class="row">'+
...
$('#kimel').click(function(){
    $('.modal-content').empty().append('<div class="modal-header">'+
        '<h2>Kimel - Graphiste</h2>'+
        '</div>'+
        '<div class="modal-body">'+
        '<div class="row">'+
        '<div>'+
        // '<img src="/assets/presentation/Kimel.png" alt="Kimel" class="img-presentation">'+
        '<p>Hello ! Je suis Kimel, j ai 20 ans, et je suis actuellement étudiante en web :) ' +
        'J ai pour passion beaucoup de choses,mais principalement les animes (SAO, DBZ, Kyoukai no Kanata...), ' +
        ' la Kpop depuis récemment (c est un monde particulier avec que des gens gentils <3) et aussi le graphisme ' +
        '(depuis 7 ans). Je souhaite devenir développeur web et apprendre à faire de jolis designs de site, parce ' +
        'que c est trop cool <3 ' +
        '</p>' +
        '</div>'+
        '</div>'+
        '<div class="row">'+
...
$('#niko').click(function(){
    $('.modal-content').empty().append('<div class="modal-header">'+
        ...
        '<div class="row">'+
        '<div>'+
        '<img src="/assets/presentation/Niko.png" alt="Niko" class="img-presentation">'+
        '<p>Salut à tous, moi c est Niko j ai 40 ans et ça fait 40 ans que je suis passionné par le manga' +
        'et la BD en général... Mes principales sources d inspirations sont des auteurs comme Akira TORIYAMA' +
        '(DBZ) et Eiichiro ODA (One Piece) et bien d autres… Fier d intégrer une équipe pleine d idées comme le ' +
        'KIPPON DREAM.  J espère que vous prendrez autant de plaisir à découvrir "les Chroniques des Skull" que' +
        'moi à les dessiner.... <br /> ' +
        'Bonne lecture avec le KIPPON DREAM et à bientôt ! ' +
        '</p>' +
        '</div>'+
        '</div>'+
        '<div class="row">'+
...
$('#twildette').click(function(){
    $('.modal-content').empty().append('<div class="modal-header">'+
        '<h2>Twildette - Graphiste </h2>'+
        '</div>'+
        '<div class="modal-body">'+
        '<div class="row">'+
        '<div>'+
        '<img src="/assets/presentation/twildette.png" alt="Twildette" class="img-presentation">'+
        '<p>Bonjooooour :D Twilde, ou Twildette ; je suis Bretonne et j’ai 23 ans ! Je suis la graphiste ' +
        'principale du Kippon Dream ! J’ai débarqué au numéro 6 sur internet; c’est moi qui m’occupe de la mise ' +
        'en page des magazines; je me suis également occupé de la partie graphique du site internet. Je suis tombée ' +
        'dans l’univers de la BD et du manga grâce à Yumi, il y a plus de 10 ans : on achetait un tome sur deux de Shaman ' +
        'King et je repassais et mettais en couleur ses dessins et ses planches. ' +
        'Ça nous rajeunit pas, mais je suis heureuse de voir à quel point on a progressé !' +
        '</p>' +
        '</div>'+
        '</div>'+
        '<div class="row">'+
